<template>
  <footer class="max-w-2xl mx-auto px-5 md:px-10 py-8 text-theme-text-tertiary flex flex-col lg:flex-row flex-wrap justify-between items-center">
    <div class="mb-4 lg:mb-0 text-center md:text-left">
      <span class="block md:inline-block mb-4 md:mb-0 text-center">&copy; <a href="https://ockham.consulting" target="_blank">OCKHAM CONSULTING</a> | {{ year }}. {{ $t("All rights reserved") }}</span> <div class="block md:inline-block"><span class="hidden md:inline-block"> | </span> <span>{{ $t("Version") }}: <a :href="versionLink" target="_blank">{{ version }}</a> | {{ $t("Date") }}: {{ date }}</span></div>
    </div>
    <div class="text-center">
      <a href="https://www.facebook.com/OckhamConsulting" target="_blank">
        <svg
          viewBox="0 0 24 24"
      ...
      <a href="https://twitter.com/OckhamConsulting" target="_blank">
        <svg
          viewBox="0 0 24 24"
          class="m-2"
          xmlns="http://www.w3.org/2000/svg"
      ...
      <a href="mailto:info@ockham.consulting" target="_blank">
        <svg
          viewBox="0 0 24 24"
          class="m-2"
          xmlns="http://www.w3.org/2000/svg"
      ...
      <a href="https://telegram.me/OckhamConsulting" target="_blank">
        <svg
          viewBox="0 0 14 14"
          class="m-2"
          xmlns="http://www.w3.org/2000/svg"
      ...
      <a href="https://www.reddit.com/r/ockhamconsulting" target="_blank">
        <svg
          viewBox="0 0 17 17"
          class="m-2"
          xmlns="http://www.w3.org/2000/svg"
      ...
      <a href="https://github.com/OckhamConsulting" target="_blank">
        <svg
          viewBox="0 0 24 24"
          class="m-2"
          xmlns="http://www.w3.org/2000/svg"
      ...
      <a href="https://ockham.consulting/slack" target="_blank">
        <svg
          viewBox="0 0 24 24"
          class="m-2"
          xmlns="http://www.w3.org/2000/svg"
      ...
      <a href="https://ockham.consulting/discord" target="_blank">
        <svg
          viewBox="0 0 24 24"
          class="m-2"
          xmlns:xlink="http://www.w3.org/1999/xlink"
      ...
      <a href="https://steemit.com/@ockhamconsulting" target="_blank">
        <svg
          viewBox="0 0 24 24"
          class="m-2"
          xmlns="http://www.w3.org/2000/svg"
      ...
      <a href="https://blog.ockham.consulting" target="_blank">
        <svg
          viewBox="0 0 24 24"
          class="m-2"
          xmlns="http://www.w3.org/2000/svg"
...
export default {
  computed: {
    ...
    versionLink() {
      return `https://github.com/gitockham/git-explorer/commit/${GIT_VERSION}`
    },
    date() {
      return GIT_DATE
    }
