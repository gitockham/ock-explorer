...
describe('rawCurrency mixin', () => {
  it('should display selected cryptocurrency with 8 digits or less', () => {
    ...
    expect(mixins.rawCurrency(10.1234567891234, 'OCK')).toEqual(displayCrypto(10.12345679))
    ...
    expect(mixins.rawCurrency(10.12345, 'OCK')).toEqual(displayCrypto(10.12345))
  })
...
describe('networkToken mixin', () => {
  it('should return the set network token', () => {
    store.dispatch('network/setToken', 'OCK')
    expect(mixins.networkToken()).toEqual('OCK')
  })

  it('should return the default network token', () => {
    store.dispatch('network/setToken', null)
    store.dispatch('network/setDefaults', { token: 'DEFAULTOCK' })
    expect(mixins.networkToken()).toEqual('DEFAULTOCK')
  })
