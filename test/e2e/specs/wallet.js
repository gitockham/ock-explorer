...
module.exports = {
  ...
  'it should be possible to show the list of forged blocks': function (browser) {
    browser
      .waitForElementVisible("//a[contains(@href, '/blocks/1') and text() = 'See all']")
      ...
      .expect.element("//div[contains(., 'Generated by')]/following-sibling::div//span[contains(., 'ockpool')]").to.be.visible
    browser
