...
module.exports = {
  ...
  'header should be able to change currency': function(browser) {
    browser.useXpath().click("//button[contains(., 'OCK/EUR')]")
    browser
      .useCss()
    ...
    browser
      ...
      .waitForElementVisible("//button[contains(., 'OCK/ETH')]")
    browser
      .click("//button[contains(., 'OCK/ETH')]")
      .useCss().waitForElementVisible('.close-button')
    browser
      .useXpath()
      .click("//button[contains(., 'EUR')]")
      .waitForElementVisible("//button[contains(., 'OCK/EUR')]")
    browser
      .useCss()
  ...
  'it should be possible to search for a known wallet': function (browser) {
    ...
    browser
      ...
      .setValue('input.search-input', ['OCKHAM Bounty', browser.Keys.ENTER])
      .pause(1000)
    browser
      .useXpath()
